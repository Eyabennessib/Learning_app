...
class A8TaskScreen extends StatefulWidget{
  const A8TaskScreen({super.key});


  @override
  State<A8TaskScreen> createState()=> _A8TaskScreen();
}

class _A8TaskScreen extends State<A8TaskScreen>{
  bool? check = false;
  ...
  dynamic Q = {
    ...
    "topic":"Word Problems",
    "question" : "I traded with locals on buying 3 rare fruits costing 8 coins each. If I paid with a 50 coin, how many coins should have left?"
  };
            ...
            child: isLoading? Container(
              ...
              children: [
                ...
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    "Trade with the locals of island",
                    style: TextStyle(
                      fontSize: 30,
