...
class A4TaskScreen extends StatefulWidget{
  const A4TaskScreen({super.key});


  @override
  State<A4TaskScreen> createState()=> _A4TaskScreen();
}

class _A4TaskScreen extends State<A4TaskScreen>{
  bool? check = false;
              ...
              children: [
                ...
                Container(
                  ...
                  child: btnVisible? ElevatedButton(
                    ...
                    onPressed: () async {
                      if(check == false){
                        goToA4InCorrect(context);
                      }


                      else{
                        goToA4Correct(context);
                      }
