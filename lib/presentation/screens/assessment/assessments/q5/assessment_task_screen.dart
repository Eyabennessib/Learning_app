...
class A5TaskScreen extends StatefulWidget{
  const A5TaskScreen({super.key});


  @override
  State<A5TaskScreen> createState()=> _A5TaskScreen();
}

class _A5TaskScreen extends State<A5TaskScreen>{
  bool? check = false;
