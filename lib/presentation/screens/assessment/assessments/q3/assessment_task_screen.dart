...
class A3TaskScreen extends StatefulWidget{
  const A3TaskScreen({super.key});


  @override
  State<A3TaskScreen> createState()=> _A3TaskScreen();
}

class _A3TaskScreen extends State<A3TaskScreen>{
  bool? check = false;
  ...
  dynamic Q = {
    ...
    "question" : "I have 3/2 of coconut water and 0.25 of juice?"
  };
