...
class A6TaskScreen extends StatefulWidget{
  const A6TaskScreen({super.key});


  @override
  State<A6TaskScreen> createState()=> _A6TaskScreen();
}

class _A6TaskScreen extends State<A6TaskScreen>{
  bool? check = false;
  ...
  dynamic Q = {
    ...
    "topic":"Geometry",
    "question" : "You found an old treasure map. It shows a triangle with all corners labeled X, one of them is  90 degrees, and another is 45 degrees. find the third angle"
  };
            ...
            child: isLoading? Container(
              ...
              children: [
                ...
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    "Calculate Angles between X marks",
                    style: TextStyle(
                      fontSize: 30,
