...
class A7TaskScreen extends StatefulWidget{
  const A7TaskScreen({super.key});


  @override
  State<A7TaskScreen> createState()=> _A7TaskScreen();
}

class _A7TaskScreen extends State<A7TaskScreen>{
  bool? check = false;
  ...
  dynamic Q = {
    ...
    "question" : "If 3x−4=2x+5, what is the value of x?"
  };
              ...
              children: [
                ...
                Container(
                  ...
                  child: btnVisible? ElevatedButton(
                    ...
                    onPressed: () async {
                      if(check == false){
                        goToA7InCorrect(context);
                      }


                      else{
                        goToA7Correct(context);
                      }
